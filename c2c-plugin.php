...
if ( ! class_exists( 'c2c_AddAdminCSS_Plugin_040' ) ) :

abstract class c2c_AddAdminCSS_Plugin_040 {
	 ...
	 * @since 036
	 */
	public function __clone() { _doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'add-admin-css' ), '036' ); }
	 ...
	 * @since 036
	 */
	public function __wakeup() { _doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'add-admin-css' ), '036' ); }
...
//				echo '<div class="hr">&nbsp;</div>' . "\n";
	...
	public function options_page() {
		...
		echo "<div class='wrap'>\n";
		echo "<div class='icon32' style='width:44px;'><img src='{$logo}' alt='" . esc_attr__( 'A plugin by coffee2code', 'add-admin-css' ) . "' /><br /></div>\n";
